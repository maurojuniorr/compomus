...
#import "/Users/mauroamazonas/Documents/Compomus/ios/Compomus-Bridging-Header.h"
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Compomus",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("MyNativeModule") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface MyNativeModule : RCTEventEmitter <CLLocationManagerDelegate>
...
- (void)screenStatus:(NSString * _Nonnull)screen;
